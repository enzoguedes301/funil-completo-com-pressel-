...
const server = http.createServer((req, res) => {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdnjs.cloudflare.com https://fast.wistia.com https://fast.wistia.net https://*.wistia.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdnjs.cloudflare.com https://fonts.googleapis.com https://fast.wistia.com https://fast.wistia.net; img-src 'self' data: https:; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; media-src 'self' blob: https://*.wistia.com https://*.wistia.net https://embedwistia-a.akamaihd.net https://embed-cloudfront.wistia.com https://*.akamaihd.net; connect-src 'self' https://api.skalepayments.com.br https://magmadatahub.com https://*.wistia.com https://*.wistia.net https://embedwistia-a.akamaihd.net https://embed-cloudfront.wistia.com https://*.akamaihd.net; frame-src https://fast.wistia.net https://*.wistia.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'");
